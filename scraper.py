...
entity_id = "NFTRXK_SAWBHNT_gov"
url = "https://www.swbh.nhs.uk/about-us/trust-publications/"
errors = 0
data = []
...
blocks = soup.find('a', text='Trust publications').find_next('ul').find_all('li')
for block in blocks:
