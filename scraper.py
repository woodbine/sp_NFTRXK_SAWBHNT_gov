...
def parse(search_term, search_tag, p):
    ...
    for search_row in search_rows:
        ...
        scraperwiki.sqlite.save(unique_keys=['Date'], data={'SearchString': search_term.encode('utf-8'), 'Search Tag': search_tag.encode('utf-8'), 'Title': title.encode('utf-8'), 'ASIN': asin, 'PubDate': pubdate, 'Author': author.encode('utf-8'), 'Format': item_format.encode('utf-8'), 'PriceRent': price_rent.encode('utf-8'), 'Price': price.encode('utf-8'), 'PriceLow': low_price.encode('utf-8'), 'OfferCount': offer_count.encode('utf-8'), 'Other1Format': other1format.encode('utf-8'), 'Other1ASIN': other1asin, 'Other2Format': other2format.encode('utf-8'), 'Other2ASIN': other2asin, 'Other3Format': other3format.encode('utf-8'), 'Other3ASIN': other3asin, 'Newer_Edition': newer, 'TradeIn': tradein.encode('utf-8'), 'Date': today_date})
